...
static void Cmd_handleballthrow(void)
{
    ...
    else
    {
        ...
        {
            //commented out to maximize catch rate constantly
        ...
        //comented out for simplicity's sake
        ...
        else // mon may be caught, calculate shakes
        {
            ...
            //commented out, this just allows master balls to have 100% catchrate, and otherwise calculates whether the catch goes through
            /*
            ...
            */
            //if [has caught pokemon on this route]
            if(gSaveBlock1Ptr->EncounteredRoutes[gMapHeader.regionMapSectionId]==1){
                shakes=0;
            }
            //otherwise
            else{
